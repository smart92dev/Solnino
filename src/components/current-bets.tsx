    ...
    <li className="list-group-item">
      <span className="bet-content">
        <div
          className={
            sel === 1
              ? 'team team-a active border-none'
              : sel === 2
              ? 'team team-a border-none'
              : 'team team-a'
          }
          onClick={() => {
            setSel(sel === 1 ? 3 : 1);
        ...
        <div
          className={sel === 2 ? 'team team-b active' : 'team team-b'}
          onClick={() => {
            setSel(sel === 2 ? 3 : 2);
          }}
        >
      ...
      <span className="total-bet">{props.data.totalBet}</span>
        ...
        <button
          ...
          onClick={() => {
            window.location.href =
              '/admin/update-match/' + props.data.address.toBase58();
          }}
        >
          Update
        </button>
