    ...
    <>
      <div className="apply-page text-center dark-mode">
        <div className="header">
          ...
          >
            <img src={SOLNINO_LOGO} alt="LOGO" height="86px"></img>
          </div>
          <div>
            <WalletMultiButton />
          </div>
        ...
        <div className="step-panel">
          ...
          <div className="step-content">
            Connect your wallet. A special treat will be sent to the wallet you
            apply with. This Wallet will be stored for future perks and rewards.
          </div>
          {publicKey == null ? (
        ...
        <div className="step-panel">
          ...
          <div className="step-content">
            Connect your Twitter profile and follow the directions
          </div>
      ...
      <div className="footer dark-footer">
        <div>
          <img src={SOLNINO_LOGO} alt="LOGO" height="45px"></img>
        </div>
        <div>
          <img
            className="twitter-link"
            src={TWITTER_IMG_Light}
            width="32px"
            alt="Twitter"
            onClick={() => {
